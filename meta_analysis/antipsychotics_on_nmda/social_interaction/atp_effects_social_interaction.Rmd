---
title: "Effects of antipsychotics on NMDA antagonist–induced social interaction deficits"
...
# ---- User inputs ----
data_path  <- "meta_social_int_antipsychotics_sb.xlsx"
sheet_name <- 1
...
pastel_fill <- function(n) {
  scales::alpha(
    colorRampPalette(c("#6F8FC8","#E6EDF7"))(n),
    0.9
  )
}
...
This systematic review and meta-analysis evaluated whether antipsychotic treatment reverses NMDA receptor antagonist–induced deficits in social interaction in animal models. Effect sizes were calculated as Hedges’ g and synthesized using multilevel random-effects models to account for dependency between multiple outcomes within experiments and studies.
...
**Overall antipsychotic effect on reversing NMDA antagonist–induced social interaction deficits.**
